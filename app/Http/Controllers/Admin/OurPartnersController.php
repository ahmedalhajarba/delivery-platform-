...
class OurPartnersController extends Controller
{
    ...
    public function index()
    {
        ...
        $ourPartners = OurPartner::with(['partner_category', 'cities', 'media'])->get();
    ...
    public function create()
    {
        ...
        $partner_categories = PartnersCategory::pluck('name_ar', 'id')->prepend(trans('global.pleaseSelect'), '');

        $cities = City::pluck('title_ar', 'id');

        return view('admin.ourPartners.create', compact('partner_categories', 'cities'));
    }

    public function store(StoreOurPartnerRequest $request)
    {
        $ourPartner = OurPartner::create($request->all());
        $ourPartner->cities()->sync($request->input('cities', []));
    ...
    public function edit(OurPartner $ourPartner)
    {
        ...
        $ourPartner->load('partner_category', 'cities');

        return view('admin.ourPartners.edit', compact('partner_categories', 'cities', 'ourPartner'));
    }
