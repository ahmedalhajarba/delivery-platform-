...
class AddressesApiController extends Controller
{
    public function index()
    {
        ...
        return new AddressResource(Address::with(['user', 'country', 'governorate', 'city', 'village'])->get());
    }
    ...
    public function show(Address $address)
    {
        ...
        return new AddressResource($address->load(['user', 'country', 'governorate', 'city', 'village']));
    }
